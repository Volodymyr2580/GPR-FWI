...
| important | not_read; metadata_pending | `GPR_references\gpr-fwi\2007a cross-hole 2D FDTD.pdf` | 2D FDTD crosshole GPR modeling/inversion | time-domain likely | pending | useful for FDTD setup |
...
| important | not_read; metadata_pending | `GPR_references\gpr-fwi\2019 Laplace Domain FWI to cross-hole Radar.pdf` | Laplace-domain crosshole radar FWI | Laplace-domain | pending | cycle skipping/low-frequency comparison |
...
| important | not_read; metadata_pending | `GPR_references\2021以来较新工作\Crosshole ground-penetrating radar FWI by combining OT and Least-square distances.pdf` | Optimal transport + least squares for crosshole GPR-FWI | pending | pending | alternative objective |
