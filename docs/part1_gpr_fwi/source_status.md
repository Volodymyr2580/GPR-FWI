...
当前已对 Meng et al. (2019) 做了针对性 PDF 抽取文本检查，确认了 Laplace-domain Maxwell system (2)-(5)、Green operator (6)、logarithmic objective (7)、gradient/virtual-source derivation (8)-(12)、model update / conjugate-gradient directions (13)-(15)、stability/step factors around (17)、stepped update 和 damping-constant discussion 等线索。正式引用时仍建议打开 PDF 视觉核对版面和印刷页码。
