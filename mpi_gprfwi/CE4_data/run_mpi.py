...
def main():
    ...
    # 执行真实模型正演（并行）
    # 注意：forward_model/forward_model_mpi 内部已经完成跨进程数据聚合并广播
    ...
    for epoch in range(num_epochs):
        ...
        # 直接使用返回的聚合结果
        data_model_combined = data_model
        wavefield_data_combined = wavefield_data if wavefield_data is not None else []
